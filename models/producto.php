...
class Producto {
    ...
    public function getAllCategory() {
        /*Se le ha puesto el alias "catnombre" al nombre de la categoria, puesto que la propiedad
        'nobmbre es comun a producto y categoria'. De esta manera se mostraran los nombre del producto
        correctamente en la vista principal 'views/layouts/header.php */
    ...
    public function save() {
        ...
        //Con esta linea imprimimos los errores que puedan haber al ingresar datos en la BBDD
        //echo $sql;
        //echo "<br>";
        //echo $this->db->error;
        //die();
